...
public class Instrucoes {
	...
	ArrayList<String> instrucoes = new ArrayList<String>(Arrays.asList(
		...
		"Essas dicas estão escondidas em QR Codes,"
		+ " os mesmos deverão ser bipados para que apareça a próxima dica. ",
		"Cada jogador poderá participar somente uma vez,"
		+ " e terá 1 hora para completar todo o percurso, das 20 as 21 horas do dia 11/09/2015. ", 
		"Serão 60 ganhadores sendo, 20 ganhadores a cada 20 minutos,"
		+ " os ganhadores serão premiados por ordem de chegada. ",
